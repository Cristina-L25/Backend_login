...
router.get('/', (req, res) => rolesPermisosController.obtenerRolPermisos(req, res));
router.get('/rol/:idrol', (req, res) => rolesPermisosController.obtenerPermisosDeRol(req, res));
router.get('/:id', (req, res) => rolesPermisosController.obtenerRolPermisoPorId(req, res));
